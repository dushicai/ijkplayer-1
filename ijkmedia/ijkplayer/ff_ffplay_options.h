...
static const AVOption ffp_context_options[] = {
    ...
    { "mediacodec-all-videos",                  "MediaCodec: enable all videos(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
        OPTION_OFFSET(mediacodec_all_videos),   OPTION_INT(0, 0, 2) },
    ...
    { "mediacodec-mpeg4",                       "MediaCodec: enable MPEG4(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
        OPTION_OFFSET(mediacodec_mpeg4),        OPTION_INT(2, 0, 2) },
    { "mediacodec-vp8",                       "MediaCodec: enable VP8(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
            OPTION_OFFSET(mediacodec_vp8),        OPTION_INT(2, 0, 2) },
    { "mediacodec-vp9",                       "MediaCodec: enable VP9(0:ffmpeg_soft,1:ijk_mediacodec,2:ffmpeg_mediacodec)",
            OPTION_OFFSET(mediacodec_vp9),        OPTION_INT(2, 0, 2) },
